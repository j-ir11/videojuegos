    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600 mb-6">Aún no has iniciado sesión. Inicia sesión para ver tu historial de pedidos.</p>
          
          <div className="flex flex-col space-y-3 items-center"> {/* Agregado items-center aquí */}
            <button
            ...
            <button
              onClick={() => navigate("/")}
              className="w-full max-w-xs flex justify-center items-center px-6 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors"
            >
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {pedidos.map((pedido) => (
              <div key={pedido.id_pedido} className="bg-white rounded-lg shadow overflow-hidden">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-gray-600">{formatFecha(pedido.fecha)}</p>
                    </div>
                    ...
                    {pedido.detallepedido?.map((detalle, i) => (
                      <div key={i} className="flex items-center">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-medium truncate">{detalle.productos?.nombre || "Producto no disponible"}</p>
